...
public class SearchHelper {
    ...
    private static ONSQueryBuilder buildContentQuery(String searchTerm, int page, String... types) {
        ...
        if (ArrayUtils.isEmpty(types)) {
            contentQuery.setTypes(PageType.bulletin.toString(), PageType.dataset.toString(), PageType.static_methodology.toString(), PageType.static_qmi.toString(), PageType.article.toString()).setPage(page);
        } else {
