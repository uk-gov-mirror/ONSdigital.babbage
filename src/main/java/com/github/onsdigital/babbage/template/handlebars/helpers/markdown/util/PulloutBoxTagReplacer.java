...
public class PulloutBoxTagReplacer extends TagReplacementStrategy {

    private static final Pattern pattern = Pattern.compile("<ons-box align=\"([a-zA-Z]*)\">(.*?)</ons-box>");
     ...
     * @param path
     */
    public PulloutBoxTagReplacer(String path, String template) {
        super(path);
    ...
    String replace(Matcher matcher) throws IOException {
        ...
        String alignment = matcher.group(1);
        ...
        additionalData.put("alignment", alignment);
